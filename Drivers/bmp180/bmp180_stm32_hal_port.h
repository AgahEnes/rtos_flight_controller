 ...
 * @return BMP180_RET_OK başarıyı, diğer kodlar HAL/bus hatasını bildirir.
 */
...
/**
 * @brief BMP180 timing callback'i olarak HAL_Delay kullanan milisaniye bekleme fonksiyonudur.
 ...
 * @return BMP180_RET_OK bekleme tamamlandığında döner.
 */
 ...
 * @param vpBusContext ts_Bmp180_Stm32BusContext pointer'ıdır.
 * @return BMP180_RET_OK başarıyı, timeout veya argüman hatasını bildirir.
 */
 ...
 * @param vpBusContext ts_Bmp180_Stm32BusContext pointer'ıdır.
 * @return BMP180_RET_OK başarıyı, durum veya argüman hatasını bildirir.
 */
 ...
 * @return BMP180_RET_OK başarıyı, geçersiz argüman hatasını bildirir.
 */
...
/**
 * @brief ts_Bmp180_TimingInterface yapısını HAL_Delay ve HAL_GetTick callback'leriyle doldurur.
