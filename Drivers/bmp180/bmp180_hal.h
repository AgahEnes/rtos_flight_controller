...
#define BMP180_CMD_READ_TEMP                      (0x2EU)     /* Sıcaklık dönüşüm komutudur; driver CONTROL register'a yazar ve bloklamasız deadline takibine geçer. */
...
/* Zamanlama sabitleri datasheet dönüşüm süreleridir; runtime state machine bu değerleri bloklamasız deadline olarak kullanır. */
#define BMP180_TEMP_CONV_TIME_MS                  (5U)        /* Sıcaklık dönüşümü için gereken minimum güvenli hazır olma süresidir. */
#define BMP180_PRESS_CONV_TIME_OSS0_MS            (5U)        /* OSS0 ultra low power basınç dönüşümü için minimum hazır olma süresidir. */
#define BMP180_PRESS_CONV_TIME_OSS1_MS            (8U)        /* OSS1 standard basınç dönüşümü için minimum hazır olma süresidir. */
#define BMP180_PRESS_CONV_TIME_OSS2_MS            (14U)       /* OSS2 high resolution basınç dönüşümü için minimum hazır olma süresidir. */
#define BMP180_PRESS_CONV_TIME_OSS3_MS            (26U)       /* OSS3 ultra high resolution basınç dönüşümü için minimum hazır olma süresidir. */
...
#define BMP180_CONVERSION_TIMEOUT_MARGIN_MS       (20U)       /* SensorTask periyodu ve bus jitter için dönüşüm süresine eklenen bounded timeout toleransıdır. */
...
#define BMP180_CONTROL_SCO_MASK                   (0x20U)     /* CONTROL register SCO bitidir; 1 dönüşüm sürüyor, 0 sonuç register'ları hazır anlamına gelir. */
